  ...
  public void insert(int key) {
    ...
    while (true){            
      ...
      if (node.keys == 3) {        
        ...
        if (node.child2 != null) {
          node.child1.parent = c1;
          node.child2.parent = c1;
          node.child3.parent = c3;
          node.child4.parent = c3;
        }
        if (node.parent == null) {          
          root = new Tree234Node(null,node.key2);          
          root.child1 = c1; c1.parent = root;          
          root.child2 = c3; c3.parent = root;
        } else {                  
          Tree234Node prt = node.parent;
          c1.parent = prt; c3.parent = prt;
          prt.keys++;                  
          if (prt.keys == 2){                        
            if (node == prt.child1){
              prt.key2 = prt.key1;
            ...
            if (node == prt.child1) {
              ...
              prt.key2 = prt.key1;
              prt.key1 = node.key2;              
              prt.child4 = prt.child3;
              prt.child3 = prt.child2;              
              prt.child1 = c1;
              prt.child2 = c3;
            } else if (node == prt.child2) {
              prt.key3 = prt.key2;
              prt.key2 = node.key2;
              prt.child4 = prt.child3;
              prt.child3 = c3;
              prt.child2 = c1;
            } else if (node == prt.child3) {
              prt.key3 = node.key2;
              prt.child4 = c3;
              prt.child3 = c1;
            }
