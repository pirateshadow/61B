...
public class Homework6Test {
  ...
  public static double expCollisions(int n, int bign){    
    double result = 1-1.0/bign;    
    double temp = 1;
    for (int i = 0; i < n; i++){
      temp *= result;
    }
    // System.out.println(bign*temp);
    result = n - bign + bign * temp;
    return result;    
  }
  ...
  public static void main(String[] args) {
    ...
    table.collisions();    
    System.out.println("expected # of collisions is : " + expCollisions(numBoards,table.numBuckets()));    

    // System.out.println(expCollisions(100, 100));
  }
}
